...
class BookingCard extends StatelessWidget {
  ...
  String get _otherName =>
      _isClient ? (booking.workerName ?? 'Worker') : (booking.clientName ?? 'Client');
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Re-post — available to both parties on cancelled bookings
                if (booking.status == 'cancelled' && onRepost != null) ...[
                  const SizedBox(height: 8),
                  SizedBox(
                    width: double.infinity,
